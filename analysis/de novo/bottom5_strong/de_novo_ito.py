...
Usage:
    ...
    python "analysis/de novo/bottom5_strong/de_novo_ito.py" --gpu 0
    python "analysis/de novo/bottom5_strong/de_novo_ito.py" --gpu 0 --n_candidates 50 --num_samples 10  # 快速测试
"""
...
def main():
    ...
    parser.add_argument('--output_dir', type=str,
                        default='/data/yanjie_huang/LLPS/predictor/PhaseFlow/analysis/de novo/bottom5_strong/de_novo_ito_results')
