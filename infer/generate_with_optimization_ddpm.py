...
Usage:
    # 测试单个相图
    python generate_with_optimization_ddpm.py --n_candidates 10 --num_samples 1 --gpu 0
...
def main():
    ...
    parser.add_argument('--checkpoint', type=str,
                        default='../outputs_ddpm/output_set_ddpm_flow32_missing15/best_model.pt')
    parser.add_argument('--input_csv', type=str,
                        default='/data/yanjie_huang/LLPS/phase_diagram/by_missing/missing_0.csv')
    parser.add_argument('--output_dir', type=str,
                        default='../generated_from_missing0/outputs_ddpm/dataset_optimized')
