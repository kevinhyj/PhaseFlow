#!/usr/bin/env python3
"""Plot DPR benchmark metrics from a tabular evaluation export."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Plot DPR benchmark metrics from a CSV file.")
...
def main() -> int:
    ...
    save_figure(fig, args.output_dir, "dpr_benchmark")
    return 0
