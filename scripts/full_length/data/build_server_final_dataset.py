...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--raw-root", default="artifacts/data/raw")
    parser.add_argument("--interim-root", default="artifacts/data/interim/server_final")
    parser.add_argument("--processed-root", default="artifacts/data/processed")
    parser.add_argument("--splits-root", default="artifacts/data/splits")
    parser.add_argument("--pseudo-root", default="artifacts/data/pseudo_labels")
    parser.add_argument("--feature-root", default="artifacts/data/features")
    parser.add_argument("--phasepdb-csv", default="artifacts/data/interim/parsed_source_tables/phasepdb3/phasepdb3_proteins.csv")
    parser.add_argument("--llpsdb-csv", default="artifacts/data/interim/parsed_source_tables/llpsdb_v2/llpsdb_v2_silver_positive_candidates.csv")
    parser.add_argument("--llpsdb-all-csv", default="artifacts/data/interim/parsed_source_tables/llpsdb_v2/llpsdb_v2_proteins.csv")
    parser.add_argument("--cd-code-proteins-csv", default="artifacts/data/interim/parsed_source_tables/cd_code/cd_code_proteins.csv")
