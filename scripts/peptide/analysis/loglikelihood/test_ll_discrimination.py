...
from phaseflow.peptide.data import collate_fn

# ============================================================================
# Config
# ============================================================================

CHECKPOINT = ROOT / "outputs_set" / "output_set_flow32_missing15" / "best_model.pt"
TEST_CSV = ROOT / "artifacts" / "data" / "peptide" / "test_set.csv"
BATCH_SIZE = 64
...
def main():
    ...
    parser.add_argument('--output', type=str, default=str(ROOT / 'artifacts' / 'results' / 'peptide' / 'analysis' / 'loglikelihood' / 'll_discrimination.png'))
    ...
    # Load test set
    dataset = PhaseDataset(str(test_csv), tokenizer=tokenizer, max_seq_len=32, split='all')
