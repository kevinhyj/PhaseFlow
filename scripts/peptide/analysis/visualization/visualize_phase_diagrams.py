...
Usage:
    python scripts/peptide/analysis/visualization/visualize_phase_diagrams.py \
      --model outputs_set/output_set_flow32_lm5_missing15 --test_path artifacts/data/peptide/test_set.csv --n 8 --gpu 2
"""
import sys
import os
import argparse
...
TEST_PATH = ROOT / 'artifacts' / 'data' / 'peptide' / 'test_set.csv'
...
def parse_args():
    ...
    parser.add_argument('--test_path', type=str, default=str(TEST_PATH), help='Test CSV path')
...
def main():
    ...
    output_path = Path(args.output) if args.output else ROOT / 'artifacts' / 'results' / 'peptide' / f'phase_diagram_visualization_{model_name}.png'
