...
Usage:
    python scripts/peptide/analysis/visualization/plot_test_histogram.py --checkpoint outputs_set/output_set_flow32_missing15/best_model.pt --test_path artifacts/data/peptide/test_set.csv
"""
...
DEFAULT_OUTPUT = ROOT / 'artifacts' / 'results' / 'peptide' / 'evaluation' / 'test_histogram_flow32_m15.png'
