...
Usage:
    python scripts/peptide/analysis/visualization/plot_top_samples.py --checkpoint outputs_set/output_set_flow32_missing15/best_model.pt --test_path artifacts/data/peptide/test_set.csv
"""
...
DEFAULT_OUT_DIR = ROOT / 'artifacts' / 'results' / 'peptide' / 'top_samples'
