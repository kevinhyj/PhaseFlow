...
Usage:
    cd 
    python "scripts/peptide/analysis/de_novo/bottom5_strong/create_ground_truth.py"
"""
...
INPUT_CSV = ROOT / 'artifacts/data/peptide/by_missing/missing_0.csv'
OUTPUT_PATH = ROOT / 'artifacts/results/peptide/analysis/de_novo/bottom5_strong/ground_truth.csv'
