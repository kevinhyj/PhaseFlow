...
Usage:
    cd 
    python "scripts/peptide/analysis/de_novo/bottom5_strong/diversity_analysis.py" --gpu 0 --n_samples 100
"""
...
OUTPUT_DIR = ROOT / 'artifacts/results/peptide/analysis/de_novo/bottom5_strong/diversity_results'
