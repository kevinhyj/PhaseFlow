...
Usage:
    cd 
    python "scripts/peptide/analysis/de_novo/top5_weak/de_novo_pipeline.py" --gpu 5
    python "scripts/peptide/analysis/de_novo/top5_weak/de_novo_pipeline.py" --gpu 5 --n_candidates 5 --n_target 100  # 快速测试
"""
...
def main():
    ...
    parser.add_argument('--output_dir', type=str,
                        default='artifacts/results/peptide/analysis/de_novo/top5_weak/de_novo_results')
