...
def main():
    ...
    RESULTS_DIR = ROOT / 'artifacts/results/peptide/analysis/de_novo/top5_weak'
    OUT_DIR = RESULTS_DIR / 'distribution_analysis'
    os.makedirs(OUT_DIR, exist_ok=True)

    # Load data
    ito = pd.read_csv(RESULTS_DIR / 'de_novo_ito_results/ito_top1.csv')
    gen = pd.read_csv(RESULTS_DIR / 'de_novo_results/candidates.csv')
    gt = pd.read_csv(RESULTS_DIR / 'ground_truth.csv')
