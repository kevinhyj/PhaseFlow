...
Usage:
    cd 
    python "scripts/peptide/analysis/de_novo/top5_weak/de_novo_ito.py" --gpu 5
    python "scripts/peptide/analysis/de_novo/top5_weak/de_novo_ito.py" --gpu 5 --n_candidates 50 --num_samples 10  # 快速测试
"""
...
def main():
    ...
    parser.add_argument('--output_dir', type=str,
                        default='artifacts/results/peptide/analysis/de_novo/top5_weak/de_novo_ito_results')
