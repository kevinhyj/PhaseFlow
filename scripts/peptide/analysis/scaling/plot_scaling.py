...
Usage:
    python scripts/peptide/analysis/scaling/plot_scaling.py
"""
...
OUTPUT_SET = ROOT / 'outputs_set'
OUTPUT_PATH = ROOT / 'artifacts/results/peptide/analysis/scaling/scaling_curve.png'
...
def collect_results():
    ...
    for label, dirname, dim, depth, heads, group in CONFIGS:
        json_path = OUTPUT_SET / dirname / 'test_results.json'
