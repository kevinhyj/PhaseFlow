...
Usage:
    python scripts/peptide/workflows/evaluate_phase2seq.py --gpu 0 --test_path artifacts/data/peptide/test_set.csv
    python scripts/peptide/workflows/evaluate_phase2seq.py --gpu 0 --dir outputs_ddpm
    python scripts/peptide/workflows/evaluate_phase2seq.py --gpu 0 --filter flow32
"""
import sys
import re
import json
...
from phaseflow.peptide.utils import set_seed

DEFAULT_TEST_PATH = ROOT / 'artifacts' / 'data' / 'peptide' / 'test_set.csv'
DEFAULT_TRAIN_PATH = ROOT / 'artifacts' / 'data' / 'peptide' / 'phase_diagram_original_scale.csv'
DEFAULT_MODELS_DIR = ROOT / 'outputs_set'
DEFAULT_OUTPUT = ROOT / 'artifacts' / 'results' / 'peptide' / 'evaluation' / 'phase2seq.json'
...
def parse_args():
    ...
    parser.add_argument('--train_path', type=str, default=str(DEFAULT_TRAIN_PATH),
                        help='Training CSV used for amino-acid reference frequencies')
    ...
    parser.add_argument('--dir', '--models_dir', dest='models_dir', type=str, default=str(DEFAULT_MODELS_DIR),
