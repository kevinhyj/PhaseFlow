...
Usage:
    python scripts/peptide/workflows/evaluate_seq2phase.py --gpu 0 --test_path artifacts/data/peptide/test_set.csv
"""
import sys
import re
import json
...
DEFAULT_OUTPUT = ROOT / 'artifacts' / 'results' / 'peptide' / 'evaluation' / 'set_seq2phase.json'
