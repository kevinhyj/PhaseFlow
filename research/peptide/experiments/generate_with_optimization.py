...
Usage:
    ...
    python research/peptide/experiments/generate_with_optimization.py --n_candidates 10 --num_samples 1 --gpu 0
...
def main():
    ...
    parser.add_argument('--output_dir', type=str,
                        default=str(ROOT / 'artifacts' / 'results' / 'peptide' / 'generated' / 'missing0_optimized'))
