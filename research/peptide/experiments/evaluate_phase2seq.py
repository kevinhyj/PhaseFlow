...
Usage:
    python research/peptide/experiments/evaluate_phase2seq.py --gpu 0 --test_path artifacts/data/peptide/test_set.csv
    python research/peptide/experiments/evaluate_phase2seq.py --gpu 0 --dir outputs_ddpm
    python research/peptide/experiments/evaluate_phase2seq.py --gpu 0 --filter flow32
"""
import sys
import re
import json
