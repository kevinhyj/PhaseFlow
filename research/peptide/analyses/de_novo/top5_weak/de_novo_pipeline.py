...
Usage:
    cd 
    python "research/peptide/analyses/de_novo/de_novo_pipeline.py" --gpu 5
    python "research/peptide/analyses/de_novo/de_novo_pipeline.py" --gpu 5 --n_candidates 5 --n_target 100  # 快速测试
"""
...
def main():
    ...
    parser.add_argument('--output_dir', type=str,
                        default='research/peptide/analyses/de_novo/top5_weak/de_novo_results')
