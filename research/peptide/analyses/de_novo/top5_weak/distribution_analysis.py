...
def main():
    OUT_DIR = 'research/peptide/analyses/de_novo/top5_weak/distribution_analysis'
    os.makedirs(OUT_DIR, exist_ok=True)

    # Load data
    ito = pd.read_csv('research/peptide/analyses/de_novo/top5_weak/de_novo_ito_results/ito_top1.csv')
    gen = pd.read_csv('research/peptide/analyses/de_novo/top5_weak/de_novo_results/candidates.csv')
    gt = pd.read_csv('research/peptide/analyses/de_novo/top5_weak/ground_truth.csv')
