...
def main():
    ...
    parser.add_argument('--checkpoint', type=str,
                        default=str(ROOT / 'outputs_set' / 'output_set_flow1_missing11' / 'best_model.pt'),
    ...
    model, config = load_model(str(checkpoint), device)
    ...
    phase_data, original_sequences, group_cols = load_missing0_data(str(input_csv))
