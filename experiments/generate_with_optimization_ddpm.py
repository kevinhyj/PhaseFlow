...
Usage:
    ...
    python experiments/generate_with_optimization_ddpm.py --n_candidates 10 --num_samples 1 --gpu 0
...
def main():
    ...
    parser.add_argument('--input_csv', type=str,
                        default=str(ROOT / 'data' / 'by_missing' / 'missing_0.csv'))
    parser.add_argument('--output_dir', type=str,
                        default=str(ROOT / 'results' / 'generated' / 'missing0_optimized_ddpm'))
