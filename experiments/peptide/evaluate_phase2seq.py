...
Usage:
    python experiments/evaluate_phase2seq.py --gpu 0 --test_path data/test_set.csv
    python experiments/evaluate_phase2seq.py --gpu 0 --dir outputs_ddpm
    python experiments/evaluate_phase2seq.py --gpu 0 --filter flow32
"""
import sys
import re
import json
...
DEFAULT_TRAIN_PATH = ROOT / 'data' / 'phase_diagram_original_scale.csv'
DEFAULT_MODELS_DIR = ROOT / 'outputs_set'
DEFAULT_OUTPUT = ROOT / 'results' / 'evaluation' / 'phase2seq.json'
