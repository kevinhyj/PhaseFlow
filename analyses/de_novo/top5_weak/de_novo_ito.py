...
Usage:
    cd 
    python "analyses/de_novo/de_novo_ito.py" --gpu 5
    python "analyses/de_novo/de_novo_ito.py" --gpu 5 --n_candidates 50 --num_samples 10  # 快速测试
"""
...
def main():
    ...
    parser.add_argument('--output_dir', type=str,
                        default='analyses/de_novo/top5_weak/de_novo_ito_results')
