...
Usage:
    cd 
    python "analyses/de_novo/bottom5_strong/de_novo_pipeline.py" --gpu 0
    python "analyses/de_novo/bottom5_strong/de_novo_pipeline.py" --gpu 0 --n_candidates 5 --num_samples 100  # 快速测试
"""
...
def main():
    ...
    parser.add_argument('--output_dir', type=str,
                        default='analyses/de_novo/bottom5_strong/de_novo_results')
