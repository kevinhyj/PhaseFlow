...
Usage:
    cd 
    python "analyses/de_novo/bottom5_strong/de_novo_ito.py" --gpu 0
    python "analyses/de_novo/bottom5_strong/de_novo_ito.py" --gpu 0 --n_candidates 50 --num_samples 10  # 快速测试
"""
...
def main():
    ...
    parser.add_argument('--input_csv', type=str,
                        default='data/by_missing/missing_0.csv')
    parser.add_argument('--output_dir', type=str,
                        default='analyses/de_novo/bottom5_strong/de_novo_ito_results')
