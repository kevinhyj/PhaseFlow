...
Usage:
    python analyses/visualization/plot_top_samples.py --checkpoint outputs_set/output_set_flow32_missing15/best_model.pt --test_path data/test_set.csv
"""
...
DEFAULT_OUT_DIR = ROOT / 'results' / 'top_samples'
