...
Usage:
    python analyses/visualization/visualize_phase_diagrams.py \
      --model outputs_set/output_set_flow32_lm5_missing15 --test_path data/test_set.csv --n 8 --gpu 2
"""
import sys
import os
import argparse
...
TEST_PATH = ROOT / 'data' / 'test_set.csv'
...
def main():
    ...
    output_path = Path(args.output) if args.output else ROOT / 'results' / f'phase_diagram_visualization_{model_name}.png'
