...
├── outputs/                      # 12个训练输出
├── experiments/                        # 推理脚本
└── analyses/sliding_window_scoring/       # 滑动窗口评分
```
...
**文件**: `configs/set_encoder_bs2048_lr0.0008_flow32_20260128.yaml`
...
**文件**: `outputs/output_set_encoder_bs2048_lr0.0008_flow32_20260128/test_results.json`
...
python experiments/train.py \
    --config configs/set_encoder_bs2048_lr0.0008_flow32_20260128.yaml \
...
```bash
cd analyses/sliding_window_scoring
...
| 文件 | 路径 | 行数 |
|------|------|------|
| 主模型 | `phaseflow/model.py` | 813 |
| Transformer | `phaseflow/transformer.py` | 326 |
| 数据处理 | `phaseflow/data.py` | 389 |
| 分词器 | `phaseflow/tokenizer.py` | 191 |
| 工具函数 | `phaseflow/utils.py` | 434 |

### 训练和推理

| 脚本 | 路径 |
|------|------|
| 训练 | `experiments/train.py` |
...
| 项 | 路径 |
|----|------|
| 最佳配置 | `configs/set_encoder_bs2048_lr0.0008_flow32_20260128.yaml` |
| 最佳模型 | `outputs/output_set_encoder_bs2048_lr0.0008_flow32_20260128/best_model.pt` |
| 测试结果 | `outputs/output_set_encoder_bs2048_lr0.0008_flow32_20260128/test_results.json` |
...
- `README.md` - 官方README
- `docs/DATALOADER_OPTIMIZATION.md` - 数据加载优化
