...
- `experiments/train.py`: 训练脚本 (~500 LOC)
...
| `configs/set_encoder_bs2048_lr0.0008_flow32_20260128.yaml` | 最佳配置 |
...
│   └── comparison/
├── analyses/sliding_window_scoring/             # 滑动窗口
│   ├── score_windows.py
│   ├── compute_idr_stats.py
│   ├── protein_window_index.pkl
│   ├── protein_window_scores.jsonl
│   └── analyses/sliding_window_scoring.log
├── scripts/                            # 辅助脚本
│   ├── train.sh
│   ├── infer.sh
│   ├── resume.sh
