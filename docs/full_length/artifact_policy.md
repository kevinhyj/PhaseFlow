...
| Source datasets | `artifacts/data/full_length/` | Distributed externally; ignored by Git |
| Derived training artifacts | `artifacts/derived/full_length/` | Distributed or regenerated externally; ignored by Git |
| Model checkpoints | `artifacts/models/full_length/` | Distributed externally; ignored by Git |
